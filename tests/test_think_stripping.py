"""Tests for <think> block stripping in OpenCTFTextEnv.
...
# The same pattern used in openctf_env.py — imported here so we test
# the exact regex behavior, not just the env integration.
_THINK_PATTERN = re.compile(r"<think>.*?</think>", re.DOTALL)


def _strip_think(text: str) -> str:
    """Simulate the stripping logic from OpenCTFTextEnv.step()."""
