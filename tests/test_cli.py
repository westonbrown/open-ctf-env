...
- open-ctf-validate runs without error (no GPU needed)
...
class TestModuleImports:
    ...
    @pytest.mark.parametrize("module", [
        "open_ctf.data.converter",
        "open_ctf.data.splitter",
        "open_ctf.rewards.reward",
        "open_ctf.formatters",
        "open_ctf.formatters.base",
        "open_ctf.formatters.qwen3",
        "open_ctf.formatters.glm4",
        "open_ctf.formatters.devstral",
        "open_ctf.formatters.tool_registry",
...
class TestValidatePipeline:
    def test_validate_runs(self):
        """open-ctf-validate should run and exit (may have warnings)."""
        result = subprocess.run(
            [sys.executable, "-m", "open_ctf.cli.validate_pipeline"],
            capture_output=True,
            text=True,
            timeout=30,
