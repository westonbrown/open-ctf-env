...
for filepath in CANDIDATES:
    ...
    new_spread = "**_resolve_chat_template_kwargs(self.generator_cfg.chat_template_kwargs)"
    ...
    print(f"patch_skyrl_chat_template_kwargs: applied to {filepath} ({count} call sites)")
    patched_count += 1
