...
for root in ["/workspace/open-ctf-env", "/workspace"]:
    ref = os.path.join(root, "references/SkyRL-westonbrown/skyrl-train/skyrl_train/workers/worker.py")
...
for filepath in CANDIDATES:
    ...
    am_ref = "action_mask" if has_local_action_mask else "(experience.action_mask if hasattr(experience, 'action_mask') and experience.action_mask is not None else None)"
