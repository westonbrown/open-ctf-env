...
filepath = "/usr/local/lib/python3.12/dist-packages/skyrl_train/distributed/fsdp_utils.py"
...
if ("_fv == 2" in content or "fsdp_version(module) == 2" in content) and "FSDP2" in content:
