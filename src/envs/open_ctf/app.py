...
try:
    ...
    from .environment import OpenCTFEnvironment
except ImportError:
    # Standalone imports (when environment is standalone with openenv from pip)
    from openenv.core.env_server.http_server import create_app
    from models import OpenCTFAction, OpenCTFObservation
    from server.environment import OpenCTFEnvironment

# Create the app with web interface and README integration
# Pass the class (factory) instead of an instance for WebSocket session support
app = create_app(OpenCTFEnvironment, OpenCTFAction, OpenCTFObservation, env_name="openctf_env")
