#!/usr/bin/env python3
"""Open CTF Challenge Management CLI.
...
DEFAULT_REGISTRY = Path(__file__).resolve().parent.parent.parent.parent / "configs" / "challenges" / "cybench.yaml"
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Open CTF Challenge Management",
    ...
    setup_parser.add_argument("--id", default=None, help="Specific challenge ID to launch")
    ...
    # -- teardown ------------------------------------------------------------
    teardown_parser = subparsers.add_parser("teardown", help="Stop challenge containers")
    teardown_parser.add_argument("--id", default=None, help="Specific challenge ID to stop")
